 ...
 * Pg 868 Chapter 13 Programming Project #3  "STUDENT DATA_PROCESS"
    ...
    Your program should be able to sort the data by any of the columns. Use 5 Comparators to achieve the sort orderings, one for each data element.   Make the data sortable by last name, student ID, and grade percentage in ascending and descending order. For example,     here are the lines of student data sorted a few different ways:
        Student data, by lastName - firstName- IDnum:
            Johnson Gus 210498 72.4 C
            Reges Stu 098736 88.2 B
            Reges Abe 298575 78.3 C
            Smith Kelly 438975 98.6 A
...
package io.github.liambloom.softwareEngineering.chapter13.programmingPojects.pp3;
...
public class CLIENT {
    public static void main(String[] args) {
        ...
        Arrays.sort(students, new Student.Comparators.LastName());
        System.out.print(" students list: ");
        System.out.print("[");
        for (int i = 0; i < students.length - 1; i++)
            System.out.print(students[i] + ", ");
        ...
        Arrays.sort(students, new Student.Comparators.ID());
        System.out.print(" students list: ");
        System.out.print("[");
        for (int i = 0; i < students.length - 1; i++)
            System.out.print(students[i] + ", ");
        ...
        Arrays.sort(students, new Student.Comparators.Average());
        System.out.print(" students list: ");
        System.out.print("[");
        for (int i = 0; i < students.length - 1; i++)
            System.out.print(students[i] + ", ");
