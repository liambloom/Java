...
import java.util.*;
import dev.liambloom.softwareEngineering.chapter8.Point;
import dev.liambloom.softwareEngineering.chapter8.TimeSpan;
...
public class Exercises {
    ...
    public static double exercise1 (final ArrayList<String> strs) { // Avg # of vowels
        ...
        return dev.liambloom.softwareEngineering.chapter7.$.avg(vowels.toArray(new Integer[0]));
    }
