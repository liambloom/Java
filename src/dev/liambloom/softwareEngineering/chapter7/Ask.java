...
public class Ask extends dev.liambloom.softwareEngineering.chapter6.Ask {
    ...
    private static String getArrayTypeString (@SuppressWarnings("rawtypes") Class type, int depth) {
        return type.getSimpleName() + dev.liambloom.softwareEngineering.chapter4.Exercises.exercise2("[]", depth);
    }
}
